...
public class TextRazorAPI {
    ...
    public static void testAccount(String apiKey, String text) throws NetworkException, AnalysisException {
 ...
 public static void testClassifier(String apiKey, String text) throws NetworkException, AnalysisException {
    ...
    public static void testDictionary(String apiKey, String text) throws NetworkException, AnalysisException {
    ...
    public static void testAnalysis(String apiKey, String text) throws NetworkException, AnalysisException {
