...
import dashboardStyle from "../javascripts/material-dashboard-react/layouts/dashboardStyle.jsx";
...
class Dashboard extends React.Component {
  ...
  async componentDidMount() {
    ...
    console.log("this is the session " + getSessionRequest.statusText)
    const { data: getSessionRequestData } = getSessionRequest;
    console.log("this is the session data " + getSessionRequestData.headers.toString())
    console.log("this is the session success " + getSessionRequestData.success)
    if (getSessionRequestData.success) {
      return userInfo = getSessionRequestData.userInfo;
    }
    //disabled it until i figure out how to manage user login and session
