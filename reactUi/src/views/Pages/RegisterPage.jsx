...
import registerPageStyle from "../javascripts/material-dashboard-react/views/registerPageStyle.jsx";
import { connect } from 'react-redux';
import registerUser from "../../middleware/register/actions";
import actions from "../../middleware/register/actions";
import {bindActionCreators} from "redux";

function mapStateToProps(state) {
  return { classes: state.registerState.classes,
    value: state.registerState.value
  };
}
