...
### Major style changes
- `src/../javascripts/material-dashboard-react/components/tasksStyle.jsx`
- `src/../javascripts/material-dashboard-react/checkboxAdnRadioStyle.jsx`
- `src/../javascripts/material-dashboard-react/components/customTabsStyle.jsx`
- `src/../javascripts/material-dashboard-react/components/snackbarContentStyle.jsx`
### Deleted dependencies
...
### Major style changes
- `src/../javascripts/material-dashboard-react/components/footerStyle.jsx`
- `src/../javascripts/material-dashboard-react/components/headerStyle.jsx`
### Added dependencies
- `@babel/runtime v7.0.0-beta.55`
### Update dependencies
...
- Added styles for `svg`'s, **font-awesome** classes and `.material-icons` class inside
  - `src/../javascripts/material-dashboard-react/views/dashboardStyle.jsx`
  - `src/../javascripts/material-dashboard-react/components/buttonStyle.jsx`
  - `src/../javascripts/material-dashboard-react/components/cardFooterStyle.jsx`
  - `src/../javascripts/material-dashboard-react/components/cardHeaderStyle.jsx`
  - `src/../javascripts/material-dashboard-react/components/headerLinksStyle.jsx`
  - `src/../javascripts/material-dashboard-react/components/customTabsStyle.jsx`
- Others
  - `src/../javascripts/material-dashboard-react/tooltipStyle.jsx`
  - `src/../javascripts/material-dashboard-react/dropdownStyle.jsx`
### Dropped components
...
### Major style changes
- Moved the styles of `src/components/` inside `src/../javascripts/material-dashboard-react/components/`
- Moved the styles of `src/layouts/` inside `src/../javascripts/material-dashboard-react/layouts/`
- Moved the styles of `src/views/` inside `src/../javascripts/material-dashboard-react/views/`
...
- Renamed `src/variables/styles.jsx` to `src/../javascripts/material-dashboard-react.jsx`
- Moved all the files from `src/variables/styles/` to `src/../javascripts/material-dashboard-react/`
