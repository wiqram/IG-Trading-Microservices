...
func needAuthenticate(url string) bool {
	safeUrls := []string{
		...
		"/demo_api.API/OpenOTCOrder",
		"/demo_api.API/GetConfirmationDetails",
		"/demo_api.API/GetClientSentiment",
		"/demo_api.API/OpenLightStreamerSubscription",
		"/demo_api.API/TestAccountTextRazor",
		"/demo_api.API/TestClassifierTextRazor",
		"/demo_api.API/TestDictionaryTextRazor",
		"/demo_api.API/TestAnalysisTextRazor",
	}
