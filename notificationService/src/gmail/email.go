...
type Email struct {
	...
	HtmlBody    string       `json:"body"` // Base64.URLEncoding
	TextBody    string       `json:"body"` // Base64.URLEncoding
	Id          string       `json:"id"`
...
func (e Email) HTML() (html string, err error) {
	data, err := base64.URLEncoding.DecodeString(e.HtmlBody)
...
func (e Email) TEXT() (html string, err error) {
	data, err := base64.URLEncoding.DecodeString(e.TextBody)
